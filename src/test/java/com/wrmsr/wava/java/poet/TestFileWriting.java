...
public final class TestFileWriting
{
    ...
    @Test
    public void pathDefaultPackage()
            throws IOException
    {
        TypeSpec type = TypeSpec.classBuilder("Test").build();
    ...
    @Test
    public void fileDefaultPackage()
            throws IOException
    {
        TypeSpec type = TypeSpec.classBuilder("Test").build();
    ...
    @Test
    public void filerDefaultPackage()
            throws IOException
    {
        TypeSpec type = TypeSpec.classBuilder("Test").build();
    ...
    @Test
    public void filerNestedClasses()
            throws IOException
    {
        TypeSpec type = TypeSpec.classBuilder("Test").build();
    ...
    @Test
    public void filerPassesOriginatingElements()
            throws IOException
    {
    ...
    @Test
    public void filerClassesWithTabIndent()
            throws IOException
    {
