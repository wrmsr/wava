...
public abstract class TestAbstractTypes
{
    ...
    public void getBasicTypeMirror()
    {
        ...
        assertThat(TypeName.get(getMirror(TestAbstractTypes.class)))
                .isEqualTo(ClassName.get(TestAbstractTypes.class));
    }
    ...
    private static class DeclaredTypeAsErrorType
