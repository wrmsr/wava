...
@Immutable
public final class JThrow
        extends JStatement
{
    private final JExpression exception;

    public JThrow(JExpression exception)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        JThrow jThrow = (JThrow) o;
        return Objects.equals(exception, jThrow.exception);
    }
    ...
    public JExpression getException()
    {
        return exception;
    }
