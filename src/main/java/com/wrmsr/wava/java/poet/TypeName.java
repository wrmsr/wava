 ...
 * com.wrmsr.wava.java.poet.ClassName#get(String, String, String...)}. To build composite types like {@code char[]} and
...
public class TypeName
{
    ...
    public static final TypeName LONG = new com.wrmsr.wava.java.poet.TypeName("long");
    ...
    {
        return mirror.accept(new SimpleTypeVisitor7<com.wrmsr.wava.java.poet.TypeName, Void>()
        {
            @Override
